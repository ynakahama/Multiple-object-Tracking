...
def imageflow_demo(predictor, vis_folder, current_time, args):
    ...
    data100_dic = {}
    all_data_dic = {}
    pic_width_x,pic_width_y = (720, 360)
    while True:
            ...
            if args.save_result:#セーブ用
                ...
                with open(path_w, mode='w') as f:
                    for trc in tracks:
                        ...
                        f.write(str(trc[0])+" "+str(trc[3])+" "+str((trc[1][0]+trc[1][2])/(2*pic_width_x))+" "+str((trc[1][1]+trc[1][3])/(2*pic_width_y))+" "+str((trc[1][2]-trc[1][0])/pic_width_x)+" "+str((trc[1][3]-trc[1][1])/pic_width_y))
                        f.write("\n")
                        #print("trc:",trc)
                        #print("trc0:",trc[0])
                        #print("trc1:",trc[1])
    ...
    with open(path_label, mode='w') as f:
        f.write(str(data_dic8))
        f.write("\n")
    f.close()
